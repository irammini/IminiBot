"""Add custom profile fields v3.9

Revision ID: 9ac1352bdad4
Revises: 0b2fafe6b6ce
Create Date: 2025-07-29 18:54:21.818079
...
revision: str = '9ac1352bdad4'
down_revision: Union[str, Sequence[str], None] = '0b2fafe6b6ce'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('profile_is_private', sa.Boolean(), server_default='false', nullable=False))
